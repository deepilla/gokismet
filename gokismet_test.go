...
// Do copies the details of the incoming request and returns
// the predefined response for the current command.
...
// addRequest creates a RequestInfo object from the provided
// HTTP request, adds it to the array, and returns it.
